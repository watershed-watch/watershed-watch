...
declare class CollisionIndex {
	grid: GridIndex<CollisionKey>;
	ignoredGrid: GridIndex<CollisionKey>;
	...
	constructor(transform: Transform$1, fogState?: FogState | null, grid?: GridIndex<CollisionKey>, ignoredGrid?: GridIndex<CollisionKey>);
	...
	placeCollisionBox(bucket: SymbolBucket, scale: number, collisionBox: SingleCollisionBox, mercatorCenter: [
		number,
		number
	], invMatrix: mat4, projectedPosOnLabelSpace: boolean, shift: Point, allowOverlap: boolean, textPixelRatio: number, posMatrix: mat4, collisionGroupPredicate?: (key: CollisionKey) => boolean): PlacedCollisionBox;
